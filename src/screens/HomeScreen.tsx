...
const styles = StyleSheet.create({
  ...
  prayerCard: { width: '31.4%', minHeight: 118, backgroundColor: colors.surface, borderRadius: radius.md, padding: 13, borderWidth: 1, borderColor: colors.border, position: 'relative' },
  ...
  prayerTime: { color: colors.navy, fontSize: 22, fontWeight: '800', marginTop: 4, letterSpacing: -0.5 },
